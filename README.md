<p align="center">
  ...
  <p align="center">基于 Spring Boot 3 的现代化全栈个人博客系统</p>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/JDK-21-000000?style=flat-square&logo=openjdk&logoColor=white" alt="JDK">
  <img src="https://img.shields.io/badge/MySQL-8.0-000000?style=flat-square&logo=mysql&logoColor=white" alt="MySQL">
  <img src="https://img.shields.io/badge/MyBatis%20Plus-3.5.7-000000?style=flat-square&logo=mybatis&logoColor=white" alt="MyBatis Plus">
  <img src="https://img.shields.io/badge/Sa--Token-1.44.0-000000?style=flat-square&logo=auth0&logoColor=white" alt="Sa-Token">
...
**Rookie Blog** 是一款专为开发者打造的现代化个人博客系统，采用前后端分离架构。项目不仅具备完善的文章管理、评论互动、用户权限等基础功能，还集成了全文搜索、国际化支持等进阶特性。代码结构清晰，模块化程度高，既适合作为个人博客使用，也是学习 Spring Boot 3 全栈开发的绝佳实战案例。
    ...
    <tr>
        ...
        <td valign="top">
            <ul>
                ...
                <li><b>Utils</b>: Hutool, Lombok, Apache Commons</li>
...
| 模块名称 | 职责说明 | 关键依赖 |
| :--- | :--- | :--- |
| **rookie-blog-app** | **启动层**<br>应用入口、配置文件 (Profile)、全局配置 | `spring-boot-starter-web` |
| **rookie-blog-web** | **接口层 (Controller)**<br>RESTful API 定义、参数校验、统一响应 | `sa-token`, `springdoc` |
| **rookie-blog-service** | **业务层 (Service)**<br>核心业务逻辑、事务控制、第三方服务集成 | `elasticsearch`, `mail` |
| **rookie-blog-repository** | **持久层 (Repository)**<br>DAO 接口、MyBatis Mapper XML、数据转换 | `mybatis-plus`, `mysql` |
| **rookie-blog-domain** | **领域层 (Domain)**<br>实体类 (Entity)、数据传输对象 (DTO)、视图对象 (VO) | `lombok`, `validation` |
| **rookie-blog-common** | **基础设施层 (Infrastructure)**<br>全局异常处理、AOP 日志、工具类、常量定义 | `hutool`, `commons-lang3` |
...
<table align="center">
    <tr>
        <td width="50%">
            ...
            <ul>
                <li><b>文章发布</b>: 支持 Markdown 编辑与实时预览</li>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li><b>国际化 (I18n)</b>: 全站中英文无缝切换支持</li>
...
*   **应用首页**: [http://localhost:8080/api](http://localhost:8080/api)
